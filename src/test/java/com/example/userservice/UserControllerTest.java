...
public class UserControllerTest {
  ...
  void addNewUser() throws Exception {
    userDTO =
        new UserDTO(
            "maxim.chikilev@gmail.com", "Maxim", "Chikilev", expectedDate, "", "");
    CustomUser customUser =
        new CustomUser(
            1L, "maxim.chikilev@gmail.com", "Maxim", "Chikilev", expectedDate, "", "");
    when(userService.dataCorrectnessCheck(userDTO)).thenReturn(errorResponseDTO);
    when(userService.create(userDTO)).thenReturn(customUser);
    mockMvc
        .perform(
            post("/users")
    ...
    userDTO =
            new UserDTO("maxim.chikilev@gmail","","",sdf.parse("2024-10-10"),"","");
